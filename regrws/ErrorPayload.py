...
#
# Generated Thu Aug  1 12:21:23 2013 by generateDS.py version 2.10a.
#
...
class error(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, components=None, additionalInfo=None, message=None, code=None, anytypeobjs_=None):
    ...
    def insert_additionalInfo(self, index, value): self.additionalInfo[index] = value
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='v1:', name_='error', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='v1:', name_='error'):
        pass
    def exportChildren(self, outfile, level, namespace_='v1:', name_='error', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for additionalInfo_ in self.additionalInfo:
            additionalInfo_.export(outfile, level, namespace_, name_='additionalInfo', pretty_print=pretty_print)
        for message_ in self.message:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smessage>%s</%smessage>%s' % (namespace_, self.gds_format_string(quote_xml(message_).encode(ExternalEncoding), input_name='message'), namespace_, eol_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for components_ in self.components:
            showIndent(outfile, level)
            outfile.write('model_.components(\n')
            components_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('additionalInfo=[\n')
        level += 1
        for additionalInfo_ in self.additionalInfo:
            showIndent(outfile, level)
            outfile.write('model_.additionalInfo(\n')
            additionalInfo_.exportLiteral(outfile, level)
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class component(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, message=None, name=None, anytypeobjs_=None):
        if message is None:
            self.message = []
        else:
            self.message = message
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='v1:', name_='component', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='v1:', name_='component'):
        pass
    def exportChildren(self, outfile, level, namespace_='v1:', name_='component', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'message':
            ...
            obj_ = self.gds_build_any(child_, 'component')
            if obj_ is not None:
                self.set_anytypeobjs_(obj_)
# end class component
...
class components(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='v1:', name_='components', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='v1:', name_='components'):
        pass
    def exportChildren(self, outfile, level, namespace_='v1:', name_='components', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportLiteral(self, outfile, level, name_='components'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
class additionalInfo(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='v1:', name_='additionalInfo', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='additionalInfo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='v1:', name_='additionalInfo'):
        pass
    def exportChildren(self, outfile, level, namespace_='v1:', name_='additionalInfo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for message_ in self.message:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smessage>%s</%smessage>%s' % (namespace_, self.gds_format_string(quote_xml(message_).encode(ExternalEncoding), input_name='message'), namespace_, eol_))
    def exportLiteral(self, outfile, level, name_='additionalInfo'):
        level += 1
        already_processed = set()
        self.exportLiteralAttributes(outfile, level, already_processed, name_)
        if self.hasContent_():
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from ErrorPayload import *\n\n')
    sys.stdout.write('import ErrorPayload as model_\n\n')
